...
{
   public com.halodi.idl.generated.geometry.Vector[] points_;

   public Triangle()
   {
      points_ = new com.halodi.idl.generated.geometry.Vector[3];

      for(int i7 = 0; i7 < points_.length; ++i7)
      {
          points_[i7] = new com.halodi.idl.generated.geometry.Vector();
      }
   }
   ...
   public void set(Triangle other)
   {
      ...
      {
            com.halodi.idl.generated.geometry.VectorPubSubType.staticCopy(other.points_[i9], points_[i9]);}
   }


   public com.halodi.idl.generated.geometry.Vector[] getPoints()
   {
      return points_;
   }
