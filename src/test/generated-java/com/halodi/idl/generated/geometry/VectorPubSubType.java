...
*
*/
public class VectorPubSubType implements us.ihmc.pubsub.TopicDataType<com.halodi.idl.generated.geometry.Vector>
{
   ...
   @Override
   public void serialize(com.halodi.idl.generated.geometry.Vector data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, com.halodi.idl.generated.geometry.Vector data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(com.halodi.idl.generated.geometry.Vector data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(com.halodi.idl.generated.geometry.Vector data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(com.halodi.idl.generated.geometry.Vector data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(com.halodi.idl.generated.geometry.Vector data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(com.halodi.idl.generated.geometry.Vector data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, com.halodi.idl.generated.geometry.Vector data)
   {
   ...
   public static void staticCopy(com.halodi.idl.generated.geometry.Vector src, com.halodi.idl.generated.geometry.Vector dest)
   {
      dest.set(src);
   }

   @Override
   public com.halodi.idl.generated.geometry.Vector createData()
   {
      return new com.halodi.idl.generated.geometry.Vector();
   }
   @Override
   ...
   public void serialize(com.halodi.idl.generated.geometry.Vector data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(com.halodi.idl.generated.geometry.Vector data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(com.halodi.idl.generated.geometry.Vector src, com.halodi.idl.generated.geometry.Vector dest)
   {
      staticCopy(src, dest);
   }
