...
*
*/
public class IDLFeatureMessagePubSubType implements us.ihmc.pubsub.TopicDataType<com.halodi.idl.generated.test.IDLFeatureMessage>
{
   ...
   @Override
   public void serialize(com.halodi.idl.generated.test.IDLFeatureMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, com.halodi.idl.generated.test.IDLFeatureMessage data) throws java.io.IOException
   {
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      current_alignment += com.halodi.idl.generated.test.IDLSubmessagePubSubType.getMaxCdrSerializedSize(current_alignment);
   ...
   public final static int getCdrSerializedSize(com.halodi.idl.generated.test.IDLFeatureMessage data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(com.halodi.idl.generated.test.IDLFeatureMessage data, int current_alignment)
   {
      int initial_alignment = current_alignment;
      ...
      current_alignment += com.halodi.idl.generated.test.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum1(), current_alignment);

      current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
      for(int i0 = 0; i0 < data.getNum2().size(); ++i0)
      {
          current_alignment += com.halodi.idl.generated.test.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum2().get(i0), current_alignment);}

      for(int i0 = 0; i0 < data.getNum3().length; ++i0)
      {
              current_alignment += com.halodi.idl.generated.test.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum3()[i0], current_alignment);
      }
      current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
      for(int i0 = 0; i0 < data.getNum4().size(); ++i0)
      {
          current_alignment += com.halodi.idl.generated.test.IDLSubmessagePubSubType.getCdrSerializedSize(data.getNum4().get(i0), current_alignment);}
   ...
   public static void write(com.halodi.idl.generated.test.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      com.halodi.idl.generated.test.IDLSubmessagePubSubType.write(data.getNum1(), cdr);
      ...
      for(int i0 = 0; i0 < data.getNum3().length; ++i0)
      {
        	com.halodi.idl.generated.test.IDLSubmessagePubSubType.write(data.getNum3()[i0], cdr);		
      }
   ...
   public static void read(com.halodi.idl.generated.test.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      ...
      com.halodi.idl.generated.test.IDLSubmessagePubSubType.read(data.getNum1(), cdr);	
      cdr.read_type_e(data.getNum2());	
      for(int i0 = 0; i0 < data.getNum3().length; ++i0)
      {
        	com.halodi.idl.generated.test.IDLSubmessagePubSubType.read(data.getNum3()[i0], cdr);	
      }
   ...
   @Override
   public final void serialize(com.halodi.idl.generated.test.IDLFeatureMessage data, us.ihmc.idl.InterchangeSerializer ser)
   {
      ...
      ser.write_type_a("num1", new com.halodi.idl.generated.test.IDLSubmessagePubSubType(), data.getNum1());

      ser.write_type_e("num2", data.getNum2());
      ser.write_type_f("num3", new com.halodi.idl.generated.test.IDLSubmessagePubSubType(), data.getNum3());
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, com.halodi.idl.generated.test.IDLFeatureMessage data)
   {
      ...
      ser.read_type_a("num1", new com.halodi.idl.generated.test.IDLSubmessagePubSubType(), data.getNum1());

      ser.read_type_e("num2", data.getNum2());
      ser.read_type_f("num3", new com.halodi.idl.generated.test.IDLSubmessagePubSubType(), data.getNum3());
   ...
   public static void staticCopy(com.halodi.idl.generated.test.IDLFeatureMessage src, com.halodi.idl.generated.test.IDLFeatureMessage dest)
   {
      dest.set(src);
   }

   @Override
   public com.halodi.idl.generated.test.IDLFeatureMessage createData()
   {
      return new com.halodi.idl.generated.test.IDLFeatureMessage();
   }
   @Override
   ...
   public void serialize(com.halodi.idl.generated.test.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(com.halodi.idl.generated.test.IDLFeatureMessage data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(com.halodi.idl.generated.test.IDLFeatureMessage src, com.halodi.idl.generated.test.IDLFeatureMessage dest)
   {
      staticCopy(src, dest);
   }
