...
public class IDLFeatureMessage extends Packet<IDLFeatureMessage> implements Settable<IDLFeatureMessage>, EpsilonComparable<IDLFeatureMessage>
{
    ...
    */
   public int hello_;
   public com.halodi.idl.generated.test.IDLSubmessage num1_;
   public us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.test.IDLSubmessage>  num2_;
   /**
    * Should be ros_msgs::msg::dds::Num num3[3];
    */
   public com.halodi.idl.generated.test.IDLSubmessage[] num3_;
   public us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.test.IDLSubmessage>  num4_;
   public string str1_;
   public string str2_;
   public us.ihmc.idl.IDLSequence.Object<string>  str3_;
   public us.ihmc.idl.IDLSequence.Object<string>  str4_;
   public us.ihmc.idl.IDLSequence.Object<string>  str5_;

   public IDLFeatureMessage()
   {
      num1_ = new com.halodi.idl.generated.test.IDLSubmessage();
      num2_ = new us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.test.IDLSubmessage> (100, new com.halodi.idl.generated.test.IDLSubmessagePubSubType());
      num3_ = new com.halodi.idl.generated.test.IDLSubmessage[3];

      for(int i1 = 0; i1 < num3_.length; ++i1)
      {
          num3_[i1] = new com.halodi.idl.generated.test.IDLSubmessage();
      }
      num4_ = new us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.test.IDLSubmessage> (3, new com.halodi.idl.generated.test.IDLSubmessagePubSubType());
      str1_ = new string(255);
      str2_ = new string(10);
      str3_ = new us.ihmc.idl.IDLSequence.Object<string> (5, "type_d");
      str4_ = new us.ihmc.idl.IDLSequence.Object<string> (100, "type_d");
      str5_ = new us.ihmc.idl.IDLSequence.Object<string> (5, "type_d");
   ...
   public void set(IDLFeatureMessage other)
   {
      ...
      com.halodi.idl.generated.test.IDLSubmessagePubSubType.staticCopy(other.num1_, num1_);
      num2_.set(other.num2_);
      for(int i3 = 0; i3 < num3_.length; ++i3)
      {
            com.halodi.idl.generated.test.IDLSubmessagePubSubType.staticCopy(other.num3_[i3], num3_[i3]);}
   ...
   public com.halodi.idl.generated.test.IDLSubmessage getNum1()
   {
      return num1_;
   }


   public us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.test.IDLSubmessage>  getNum2()
   {
      return num2_;
   }
    ...
    * Should be ros_msgs::msg::dds::Num num3[3];
    */
   public com.halodi.idl.generated.test.IDLSubmessage[] getNum3()
   {
      return num3_;
   }


   public us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.test.IDLSubmessage>  getNum4()
   {
      return num4_;
   }
   ...
   public us.ihmc.idl.IDLSequence.Object<string>  getStr3()
   {
      return str3_;
   }


   public us.ihmc.idl.IDLSequence.Object<string>  getStr4()
   {
      return str4_;
   }


   public us.ihmc.idl.IDLSequence.Object<string>  getStr5()
   {
      return str5_;
   }
   ...
   public boolean epsilonEquals(IDLFeatureMessage other, double epsilon)
   {
      ...
      if (this.str3_.size() != other.str3_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.str3_.size(); i++)
         {  if (!this.str3_.get(i).epsilonEquals(other.str3_.get(i), epsilon)) return false; }
      }

      if (this.str4_.size() != other.str4_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.str4_.size(); i++)
         {  if (!this.str4_.get(i).epsilonEquals(other.str4_.get(i), epsilon)) return false; }
      }

      if (this.str5_.size() != other.str5_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.str5_.size(); i++)
         {  if (!this.str5_.get(i).epsilonEquals(other.str5_.get(i), epsilon)) return false; }
      }
