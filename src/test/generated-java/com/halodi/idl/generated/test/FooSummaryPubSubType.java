...
*
*/
public class FooSummaryPubSubType implements us.ihmc.pubsub.TopicDataType<com.halodi.idl.generated.test.FooSummary>
{
   ...
   @Override
   public void serialize(com.halodi.idl.generated.test.FooSummary data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, com.halodi.idl.generated.test.FooSummary data) throws java.io.IOException
   {
   ...
   public final static int getCdrSerializedSize(com.halodi.idl.generated.test.FooSummary data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(com.halodi.idl.generated.test.FooSummary data, int current_alignment)
   {
      int initial_alignment = current_alignment;
   ...
   public static void write(com.halodi.idl.generated.test.FooSummary data, us.ihmc.idl.CDR cdr)
   {
   ...
   public static void read(com.halodi.idl.generated.test.FooSummary data, us.ihmc.idl.CDR cdr)
   {
   ...
   @Override
   public final void serialize(com.halodi.idl.generated.test.FooSummary data, us.ihmc.idl.InterchangeSerializer ser)
   {
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, com.halodi.idl.generated.test.FooSummary data)
   {
   ...
   public static void staticCopy(com.halodi.idl.generated.test.FooSummary src, com.halodi.idl.generated.test.FooSummary dest)
   {
      dest.set(src);
   }

   @Override
   public com.halodi.idl.generated.test.FooSummary createData()
   {
      return new com.halodi.idl.generated.test.FooSummary();
   }
   @Override
   ...
   public void serialize(com.halodi.idl.generated.test.FooSummary data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(com.halodi.idl.generated.test.FooSummary data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(com.halodi.idl.generated.test.FooSummary src, com.halodi.idl.generated.test.FooSummary dest)
   {
      staticCopy(src, dest);
   }
