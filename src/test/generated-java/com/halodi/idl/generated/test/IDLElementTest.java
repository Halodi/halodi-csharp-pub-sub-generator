...
public class IDLElementTest extends Packet<IDLElementTest> implements Settable<IDLElementTest>, EpsilonComparable<IDLElementTest>
{
   ...
   public ushort ushortTest_;
   public int longTest_;
   public uint ulongTest_;
   public long longlongTest_;
   public ulong ulonglongTest_;
   public float floatTest_;
   public double doubleTest_;
   public bool booleanTest_;
   public com.halodi.idl.generated.test.Color colorTest_;
   public com.halodi.idl.generated.nested.NestedElement nestedElementTest_;
   public string stringTest_;
   public int[] longArray_;
   public com.halodi.idl.generated.nested.NestedElement[][] nestedArray_;
   public string[] stringArray_;
   public com.halodi.idl.generated.test.Color[] enumArray_;
   ...
   public us.ihmc.idl.IDLSequence.Object<ushort>  ushortSeqTest_;
   public us.ihmc.idl.IDLSequence.Integer  longSeqTest_;
   public us.ihmc.idl.IDLSequence.Object<uint>  ulongSeqTest_;
   public us.ihmc.idl.IDLSequence.Long  longlongSeqtest_;
   public us.ihmc.idl.IDLSequence.Object<ulong>  ulonglongSeqTest_;
   public us.ihmc.idl.IDLSequence.Float  floatSeqTest_;
   public us.ihmc.idl.IDLSequence.Double  doubleSeqTest_;
   public us.ihmc.idl.IDLSequence.Object<bool>  booleanSeqTest_;
   public us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.nested.NestedElement>  nestedSeqTest_;
   public us.ihmc.idl.IDLSequence.Enum<com.halodi.idl.generated.test.Color> enumSeqTest_;
   public us.ihmc.idl.IDLSequence.Object<string>  stringSeqTest_;

   public IDLElementTest()
   {
      nestedElementTest_ = new com.halodi.idl.generated.nested.NestedElement();
      stringTest_ = new string(255);
      longArray_ = new int[10];

      nestedArray_ = new com.halodi.idl.generated.nested.NestedElement[5][3];

      for(int i1 = 0; i1 < nestedArray_.length; ++i1)
      {
        for(int i2 = 0; i2 < nestedArray_[i1].length; ++i2)
        {
            nestedArray_[i1][i2] = new com.halodi.idl.generated.nested.NestedElement();
        }
      }
      stringArray_ = new string[4];

      for(int i4 = 0; i4 < stringArray_.length; ++i4)
      {
          stringArray_[i4] = new string();
      }
      enumArray_ = new com.halodi.idl.generated.test.Color[6];
      ...
      ushortSeqTest_ = new us.ihmc.idl.IDLSequence.Object<ushort> (25, "type_3");

      longSeqTest_ = new us.ihmc.idl.IDLSequence.Integer (25, "type_2");

      ulongSeqTest_ = new us.ihmc.idl.IDLSequence.Object<uint> (25, "type_4");

      longlongSeqtest_ = new us.ihmc.idl.IDLSequence.Long (25, "type_11");

      ulonglongSeqTest_ = new us.ihmc.idl.IDLSequence.Object<ulong> (25, "type_12");

      floatSeqTest_ = new us.ihmc.idl.IDLSequence.Float (25, "type_5");

      doubleSeqTest_ = new us.ihmc.idl.IDLSequence.Double (25, "type_6");

      booleanSeqTest_ = new us.ihmc.idl.IDLSequence.Object<bool> (25, "type_7");

      nestedSeqTest_ = new us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.nested.NestedElement> (25, new com.halodi.idl.generated.nested.NestedElementPubSubType());
      enumSeqTest_ = new us.ihmc.idl.IDLSequence.Enum<com.halodi.idl.generated.test.Color>(25, com.halodi.idl.generated.test.Color.class, com.halodi.idl.generated.test.Color.values);

      stringSeqTest_ = new us.ihmc.idl.IDLSequence.Object<string> (25, "type_d");
   ...
   public void set(IDLElementTest other)
   {
      ...
      com.halodi.idl.generated.nested.NestedElementPubSubType.staticCopy(other.nestedElementTest_, nestedElementTest_);
      ...
      for(int i8 = 0; i8 < nestedArray_.length; ++i8)
      {
         ...
         {
               com.halodi.idl.generated.nested.NestedElementPubSubType.staticCopy(other.nestedArray_[i8][i9], nestedArray_[i8][i9]);}
      }
   ...
   public void setUshortTest(ushort ushortTest)
   {
      ushortTest_ = ushortTest;
   }
   public ushort getUshortTest()
   {
      return ushortTest_;
   }
   ...
   public void setUlongTest(uint ulongTest)
   {
      ulongTest_ = ulongTest;
   }
   public uint getUlongTest()
   {
      return ulongTest_;
   }
   ...
   public void setUlonglongTest(ulong ulonglongTest)
   {
      ulonglongTest_ = ulonglongTest;
   }
   public ulong getUlonglongTest()
   {
   ...
   public void setBooleanTest(bool booleanTest)
   {
      booleanTest_ = booleanTest;
   }
   public bool getBooleanTest()
   {
      return booleanTest_;
   }

   public void setColorTest(com.halodi.idl.generated.test.Color colorTest)
   {
      colorTest_ = colorTest;
   }
   public com.halodi.idl.generated.test.Color getColorTest()
   {
      return colorTest_;
   }


   public com.halodi.idl.generated.nested.NestedElement getNestedElementTest()
   {
   ...
   public com.halodi.idl.generated.nested.NestedElement[][] getNestedArray()
   {
      return nestedArray_;
   }
   ...
   public com.halodi.idl.generated.test.Color[] getEnumArray()
   {
      return enumArray_;
   }
   ...
   public us.ihmc.idl.IDLSequence.Object<ushort>  getUshortSeqTest()
   {
   ...
   public us.ihmc.idl.IDLSequence.Object<uint>  getUlongSeqTest()
   {
   ...
   public us.ihmc.idl.IDLSequence.Object<ulong>  getUlonglongSeqTest()
   {
   ...
   public us.ihmc.idl.IDLSequence.Object<bool>  getBooleanSeqTest()
   {
      return booleanSeqTest_;
   }


   public us.ihmc.idl.IDLSequence.Object<com.halodi.idl.generated.nested.NestedElement>  getNestedSeqTest()
   {
      return nestedSeqTest_;
   }


   public us.ihmc.idl.IDLSequence.Enum<com.halodi.idl.generated.test.Color> getEnumSeqTest()
   {
      return enumSeqTest_;
   }


   public us.ihmc.idl.IDLSequence.Object<string>  getStringSeqTest()
   {
   ...
   public boolean epsilonEquals(IDLElementTest other, double epsilon)
   {
      ...
      if (this.ushortSeqTest_.size() != other.ushortSeqTest_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.ushortSeqTest_.size(); i++)
         {  if (!this.ushortSeqTest_.get(i).epsilonEquals(other.ushortSeqTest_.get(i), epsilon)) return false; }
      }

      if (!us.ihmc.idl.IDLTools.epsilonEqualsIntegerSequence(this.longSeqTest_, other.longSeqTest_, epsilon)) return false;

      if (this.ulongSeqTest_.size() != other.ulongSeqTest_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.ulongSeqTest_.size(); i++)
         {  if (!this.ulongSeqTest_.get(i).epsilonEquals(other.ulongSeqTest_.get(i), epsilon)) return false; }
      }

      if (!us.ihmc.idl.IDLTools.epsilonEqualsLongSequence(this.longlongSeqtest_, other.longlongSeqtest_, epsilon)) return false;

      if (this.ulonglongSeqTest_.size() != other.ulonglongSeqTest_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.ulonglongSeqTest_.size(); i++)
         {  if (!this.ulonglongSeqTest_.get(i).epsilonEquals(other.ulonglongSeqTest_.get(i), epsilon)) return false; }
      }
      ...
      if (this.booleanSeqTest_.size() != other.booleanSeqTest_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.booleanSeqTest_.size(); i++)
         {  if (!this.booleanSeqTest_.get(i).epsilonEquals(other.booleanSeqTest_.get(i), epsilon)) return false; }
      }
      ...
      if (this.stringSeqTest_.size() != other.stringSeqTest_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.stringSeqTest_.size(); i++)
         {  if (!this.stringSeqTest_.get(i).epsilonEquals(other.stringSeqTest_.get(i), epsilon)) return false; }
      }
