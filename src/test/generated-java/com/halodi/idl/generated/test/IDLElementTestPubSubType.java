...
*
*/
public class IDLElementTestPubSubType implements us.ihmc.pubsub.TopicDataType<com.halodi.idl.generated.test.IDLElementTest>
{
   ...
   @Override
   public void serialize(com.halodi.idl.generated.test.IDLElementTest data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, com.halodi.idl.generated.test.IDLElementTest data) throws java.io.IOException
   {
   ...
   public static int getMaxCdrSerializedSize(int current_alignment)
   {
      ...
      current_alignment += com.halodi.idl.generated.nested.NestedElementPubSubType.getMaxCdrSerializedSize(current_alignment);
   ...
   public final static int getCdrSerializedSize(com.halodi.idl.generated.test.IDLElementTest data)
   {
      return getCdrSerializedSize(data, 0);
   }

   public final static int getCdrSerializedSize(com.halodi.idl.generated.test.IDLElementTest data, int current_alignment)
   {
      int initial_alignment = current_alignment;
      ...
      current_alignment += com.halodi.idl.generated.nested.NestedElementPubSubType.getCdrSerializedSize(data.getNestedElementTest(), current_alignment);
      ...
      for(int i0 = 0; i0 < data.getNestedArray().length; ++i0)
      {
          ...
          {
                  current_alignment += com.halodi.idl.generated.nested.NestedElementPubSubType.getCdrSerializedSize(data.getNestedArray()[i0][i1], current_alignment);
          }
      }
      ...
      {
          current_alignment += com.halodi.idl.generated.nested.NestedElementPubSubType.getCdrSerializedSize(data.getNestedSeqTest().get(i0), current_alignment);}
   ...
   public static void write(com.halodi.idl.generated.test.IDLElementTest data, us.ihmc.idl.CDR cdr)
   {
      ...
      com.halodi.idl.generated.nested.NestedElementPubSubType.write(data.getNestedElementTest(), cdr);
      ...
      for(int i0 = 0; i0 < data.getNestedArray().length; ++i0)
      {
        for(int i1 = 0; i1 < data.getNestedArray()[i0].length; ++i1)
        {
          	com.halodi.idl.generated.nested.NestedElementPubSubType.write(data.getNestedArray()[i0][i1], cdr);		
        }
      }
   ...
   public static void read(com.halodi.idl.generated.test.IDLElementTest data, us.ihmc.idl.CDR cdr)
   {
      ...
      data.setColorTest(com.halodi.idl.generated.test.Color.values[cdr.read_type_c()]);
      	
      com.halodi.idl.generated.nested.NestedElementPubSubType.read(data.getNestedElementTest(), cdr);	
      ...
      for(int i0 = 0; i0 < data.getNestedArray().length; ++i0)
      {
        for(int i1 = 0; i1 < data.getNestedArray()[i0].length; ++i1)
        {
          	com.halodi.idl.generated.nested.NestedElementPubSubType.read(data.getNestedArray()[i0][i1], cdr);	
        }
      }
      ...
      for(int i0 = 0; i0 < data.getEnumArray().length; ++i0)
      {
           ...
           if (ordinal < 0)
              ...
              data.getEnumArray()[i0] = com.halodi.idl.generated.test.Color.values[ordinal];
   ...
   @Override
   public final void serialize(com.halodi.idl.generated.test.IDLElementTest data, us.ihmc.idl.InterchangeSerializer ser)
   {
      ...
      ser.write_type_a("nestedElementTest", new com.halodi.idl.generated.nested.NestedElementPubSubType(), data.getNestedElementTest());

      ser.write_type_d("stringTest", data.getStringTest());
      ser.write_type_f("longArray", data.getLongArray());
      ser.write_type_f("nestedArray", new com.halodi.idl.generated.nested.NestedElementPubSubType(), data.getNestedArray());
   ...
   @Override
   public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, com.halodi.idl.generated.test.IDLElementTest data)
   {
      ...
      data.setColorTest((com.halodi.idl.generated.test.Color)ser.read_type_c("colorTest", com.halodi.idl.generated.test.Color.class));

      ser.read_type_a("nestedElementTest", new com.halodi.idl.generated.nested.NestedElementPubSubType(), data.getNestedElementTest());

      ser.read_type_d("stringTest", data.getStringTest());
      ser.read_type_f("longArray", data.getLongArray());
      ser.read_type_f("nestedArray", new com.halodi.idl.generated.nested.NestedElementPubSubType(), data.getNestedArray());
   ...
   public static void staticCopy(com.halodi.idl.generated.test.IDLElementTest src, com.halodi.idl.generated.test.IDLElementTest dest)
   {
      dest.set(src);
   }

   @Override
   public com.halodi.idl.generated.test.IDLElementTest createData()
   {
      return new com.halodi.idl.generated.test.IDLElementTest();
   }
   @Override
   ...
   public void serialize(com.halodi.idl.generated.test.IDLElementTest data, us.ihmc.idl.CDR cdr)
   {
      write(data, cdr);
   }

   public void deserialize(com.halodi.idl.generated.test.IDLElementTest data, us.ihmc.idl.CDR cdr)
   {
      read(data, cdr);
   }
   
   public void copy(com.halodi.idl.generated.test.IDLElementTest src, com.halodi.idl.generated.test.IDLElementTest dest)
   {
      staticCopy(src, dest);
   }
