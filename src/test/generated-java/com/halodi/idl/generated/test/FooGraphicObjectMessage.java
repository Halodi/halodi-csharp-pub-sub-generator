...
public class FooGraphicObjectMessage extends Packet<FooGraphicObjectMessage> implements Settable<FooGraphicObjectMessage>, EpsilonComparable<FooGraphicObjectMessage>
{
   ...
   public string name_;
   public us.ihmc.idl.IDLSequence.Object<ushort>  yoVariableIndex_;
   public us.ihmc.idl.IDLSequence.Double  constants_;
   public com.halodi.idl.generated.test.FooAppearanceDefinitionMessage appearance_;
   public string listName_;

   public FooGraphicObjectMessage()
   {
      name_ = new string(255);
      yoVariableIndex_ = new us.ihmc.idl.IDLSequence.Object<ushort> (1024, "type_3");

      constants_ = new us.ihmc.idl.IDLSequence.Double (128, "type_6");

      appearance_ = new com.halodi.idl.generated.test.FooAppearanceDefinitionMessage();
      listName_ = new string(255);
   }
   ...
   public void set(FooGraphicObjectMessage other)
   {
      ...
      com.halodi.idl.generated.test.FooAppearanceDefinitionMessagePubSubType.staticCopy(other.appearance_, appearance_);
   ...
   public us.ihmc.idl.IDLSequence.Object<ushort>  getYoVariableIndex()
   {
   ...
   public com.halodi.idl.generated.test.FooAppearanceDefinitionMessage getAppearance()
   {
      return appearance_;
   }
   ...
   public boolean epsilonEquals(FooGraphicObjectMessage other, double epsilon)
   {
      ...
      if (this.yoVariableIndex_.size() != other.yoVariableIndex_.size()) { return false; }
      else
      {
         for (int i = 0; i < this.yoVariableIndex_.size(); i++)
         {  if (!this.yoVariableIndex_.get(i).epsilonEquals(other.yoVariableIndex_.get(i), epsilon)) return false; }
      }
