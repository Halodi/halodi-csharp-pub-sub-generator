...
public class FooYoVariableDefinition extends Packet<FooYoVariableDefinition> implements Settable<FooYoVariableDefinition>, EpsilonComparable<FooYoVariableDefinition>
{
   ...
   public com.halodi.idl.generated.test.FooYoType type_;
   public ushort registry_;
   public ushort enumType_;
   public bool allowNullValues_;
   public bool isParameter_;
   public double min_;
   public double max_;
   public com.halodi.idl.generated.test.FooLoadStatus loadStatus_;

   public FooYoVariableDefinition()
   {
      name_ = new string(255);
      description_ = new string(255);
   }
   ...
   public void setType(com.halodi.idl.generated.test.FooYoType type)
   {
      type_ = type;
   }
   public com.halodi.idl.generated.test.FooYoType getType()
   {
      return type_;
   }

   public void setRegistry(ushort registry)
   {
      registry_ = registry;
   }
   public ushort getRegistry()
   {
      return registry_;
   }

   public void setEnumType(ushort enumType)
   {
      enumType_ = enumType;
   }
   public ushort getEnumType()
   {
      return enumType_;
   }

   public void setAllowNullValues(bool allowNullValues)
   {
      allowNullValues_ = allowNullValues;
   }
   public bool getAllowNullValues()
   {
      return allowNullValues_;
   }

   public void setIsParameter(bool isParameter)
   {
      isParameter_ = isParameter;
   }
   public bool getIsParameter()
   {
      return isParameter_;
   }
   ...
   public void setLoadStatus(com.halodi.idl.generated.test.FooLoadStatus loadStatus)
   {
      loadStatus_ = loadStatus;
   }
   public com.halodi.idl.generated.test.FooLoadStatus getLoadStatus()
   {
      return loadStatus_;
   }
